...
export default function FriendCompare({
    ...
    return (
        <div className="bg-white dark:bg-[var(--bg-surface)] rounded-3xl shadow-xl p-6 mb-6 border border-[var(--border-default)] dark:border-[var(--border-default)]">
            <h3 className="text-xl font-bold text-[var(--text-primary)] dark:text-[var(--text-secondary)] mb-6 text-center flex items-center justify-center gap-2">
                <span className="text-pink-500">🤝</span> 친구 결과랑 비교하기
            </h3>

            <div className="space-y-4">
                <div>
                    <label htmlFor="friend-link" className="block text-sm font-medium text-[var(--text-primary)] dark:text-[var(--text-secondary)] mb-2 ml-1">
                        친구의 결과 링크를 입력해주세요
                    </label>
                    <div className="flex flex-col sm:flex-row gap-2">
                        <div className="flex-1">
                            <input
                                ...
                                className={`w-full px-4 py-3 rounded-xl border-2 focus:ring-2 focus:outline-none text-[var(--text-primary)] dark:text-[var(--text-secondary)] bg-white dark:bg-[var(--bg-surface)] transition-all ${
                                    errors.friendLink
                                        ? 'border-red-300 focus:border-red-500 focus:ring-red-200'
                                        : 'border-[var(--border-default)] dark:border-[var(--border-default)] focus:border-pink-500 focus:ring-pink-200'
                                }`}
                ...
                <div className="bg-purple-50 dark:bg-purple-900/20 rounded-2xl p-4 border border-purple-100 dark:border-purple-800/50">
                    <div className="flex gap-3">
                        ...
                        <div className="text-sm text-[var(--text-primary)] dark:text-[var(--text-secondary)] leading-relaxed">
