  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-pink-50 via-purple-50 to-blue-50 dark:from-[var(--bg-surface)] dark:via-purple-950 dark:to-[var(--bg-surface)]">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        {/* Main Card */}
        <div className="bg-white dark:bg-[var(--bg-surface)] rounded-3xl shadow-xl overflow-hidden">
          {/* Hero Section */}
          <div className="bg-gradient-to-r from-pink-100 to-purple-100 dark:from-[var(--bg-surface)] dark:to-[var(--bg-surface)] p-8">
          ...
          <div className="p-8">
              ...
              <div className="space-y-4">
                {['activity', 'affection', 'social', 'quiet', 'loyalty'].map((stat) => (
                  <div key={stat} className="flex items-center gap-4">
                    ...
                    <div className="flex-1 h-3 bg-[var(--bg-page)] dark:bg-[var(--bg-surface)] rounded-full">
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-3 gap-4">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="text-center p-4 bg-[var(--bg-page)] dark:bg-[var(--bg-surface)] rounded-xl">
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {[1, 2, 3, 4, 5, 6].map((i) => (
                  <div key={i} className="flex items-center gap-3 p-3 bg-[var(--bg-page)] dark:bg-[var(--bg-surface)] rounded-lg">
