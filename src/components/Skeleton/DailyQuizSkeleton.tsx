  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-pink-50 via-purple-50 to-blue-50 dark:from-[var(--bg-surface)] dark:via-purple-950 dark:to-[var(--bg-surface)]">
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        ...
        {/* Quiz Card */}
        <div className="bg-white dark:bg-[var(--bg-surface)] rounded-2xl shadow-lg p-8 border border-[var(--border-default)] dark:border-[var(--border-default)]">
          ...
          <div className="space-y-3">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="w-full p-4 rounded-xl border-2 border-[var(--border-default)] dark:border-[var(--border-default)]">
        ...
        {/* Milestones */}
        <div className="mt-8 bg-white/50 dark:bg-[var(--bg-surface)] rounded-2xl p-6 border border-[var(--border-default)] dark:border-[var(--border-default)]">
