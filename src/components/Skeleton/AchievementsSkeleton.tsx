      ...
      <main className="min-h-screen bg-gradient-to-b from-pink-50 via-purple-50 to-blue-50 dark:from-gray-900 dark:via-purple-950 dark:to-gray-900">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-4">
          ...
          {/* Achievement Gallery */}
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-6 mb-8 border border-transparent dark:border-gray-700">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-6 mb-8 border border-transparent dark:border-gray-700">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="p-4 rounded-xl border-2 border-gray-200 dark:border-gray-600">
