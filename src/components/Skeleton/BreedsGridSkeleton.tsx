  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
      {Array.from({ length: count }).map((_, i) => (
        <div
          key={i}
          className="bg-white dark:bg-[var(--bg-surface)] rounded-2xl shadow-md p-5 border border-[var(--border-default)] dark:border-[var(--border-default)] hover:shadow-md transition-all"
        >
